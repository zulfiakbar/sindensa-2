                ...
                <div class="py-6">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        <div class="flex justify-between items-end">
                            <h1 class="text-2xl font-semibold text-gray-900">Tambah Jabatans</h1>
                            <!-- User info  -->
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div class="py-5">
                            <form id="form-data" action="/admin/jabatan" method="post">
                                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-4">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="text" name="name" id="jabatan" autocomplete="jabatan" class="flex-1 focus:ring-blue-500 focus:border-blue-500 block w-full min-w-0 rounded sm:text-sm border-gray-300">
                                        </div>
                                    </div>
